...
insert into vozilo (marka,broj_registracije,broj_mjesta) values ('škoda','NA-589-KL',4), 
('bmw','OS-589-LI',4),
('opel','OS-689-OO',8),
('škoda','OS-512-VM',4), 
('škoda','OS-742-MM',4),
('škoda','OS-002-DG',4),
('bmw','OS-402-PO',4),
('Mercedes','OS-7O2-AA',4),
('škoda','OS-000-SA',4),
('škoda','OS-123-TZ',4),
('mercedes','OS-782-KL',4),
('škoda','OS-566-ZU',4),
('škoda','OS-101-KL',4);

insert into vozac(ime,prezime,broj_vozacke,vozilo) values ('zoran','mrvonjić','7894562',1),('luka','onjić','1234562',2),('zvonko','mikić','7894592',3),
...
('miro','0956935894','Županijska 8','Istarska 5b'),('pavao','095589364','Ružina 4','VIM 49'),
('ana','031000769','hutlerova 51','frankopanska 73'), ('tena','099875632','Sunčana 29','vukovarska 120');
